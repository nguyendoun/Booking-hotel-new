...
<!-- Style --> <link rel="stylesheet" href="../resources/css/loginUser.css" type="text/css" media="all">
	...
	<h2>Login here</h2>
		...
		@csrf
			...
			<div class="aitssendbuttonw3ls">
				...
				<p> To register new account <span>→</span> <a class="w3_play_icon1" href="{{ route('home.register')}}"> Click Here</a></p>
				<div class="clear"></div>
			</div>
		</form>
	</div>
